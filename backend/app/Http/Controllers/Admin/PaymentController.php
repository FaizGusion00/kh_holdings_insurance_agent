...
class PaymentController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'payment_method' => 'required|in:bank_transfer,credit_card,debit_card,cash,online_banking',
        ...
        $transactionId = 'TXN' . date('Ymd') . str_pad(PaymentTransaction::count() + 1, 4, '0', STR_PAD_LEFT);
