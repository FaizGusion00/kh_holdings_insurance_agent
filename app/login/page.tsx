										...
										<form className="space-y-6" onSubmit={handleLogin}>
												...
												<div className="space-y-2">
													...
													<div className="flex gap-2">
														<input 
															value="AGT" 
															disabled 
															className="w-12 h-12 rounded-lg border border-gray-200 bg-gray-50 text-center text-gray-600 font-medium" 
														/>
														<input 
															name="phone"
															...
															pattern="[0-9]*"
															inputMode="numeric"
															className="flex-1 h-12 rounded-lg border border-gray-200 px-3 focus:outline-none focus:ring-2 focus:ring-gray-300 focus:border-gray-300 transition-all duration-200 input-enhanced" 
														/>
													</div>
												</div>
											</FadeIn>
											...
											<FadeIn delay={1.0}>
												<div className="space-y-2">
													...
													<input 
														...
														type="password" 
														className="w-full h-12 rounded-lg border border-gray-200 px-3 focus:outline-none focus:ring-2 focus:ring-gray-300 focus:border-gray-300 transition-all duration-200 input-enhanced" 
													/>
												</div>
											</FadeIn>
											...
											<FadeIn delay={1.2}>
												<div className="flex items-center justify-end text-sm">
													<Link href="#" className="text-gray-600 hover:underline hover:text-gray-700 transition-colors">
														Forgot Password ?
													</Link>
												</div>
											</FadeIn>
