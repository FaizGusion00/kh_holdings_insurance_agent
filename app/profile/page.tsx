...
export default function ProfilePage() {
	...
	const [profileForm, setProfileForm] = useState({
		name: "NOR ZAKIAH BINTI WAN OMAR",
		email: "KING.KHIC@GMAIL.COM",
		streetAddress: "NO 27A JALAN SG 1/6 TAMAN SRI GOMBAK",
		postalCode: "68100",
		state: "Selangor",
		city: "BATU CAVES",
		accountPassword: ""
	...
	const handlePhoneContinue = () => {
		...
		} else if (phoneChangeStep === 'tac-verification') {
			if (tacCode.trim()) {
	...
	const paymentHistoryData: PaymentData[] = [
		{
			description: "Membership Fee - KHAIRUL HAFFIZ BIN KHAIRUL OMAR KUMAR",
			amount: "40.00",
			method: "Mandate",
			status: "Success",
			date: "13/08/2024 03:00 AM"
		},
		{
			description: "Membership Fee - NOR ZAKIAH BINTI WAN OMAR",
			amount: "40.00",
			method: "Mandate",
			status: "Success",
			date: "10/08/2024 03:00 AM"
		},
		{
			description: "Deposit Topup - NOR ZAKIAH BINTI WAN OMAR",
			amount: "51.28",
			method: "Mandate",
			status: "Success",
			date: "07/08/2024 13:37 PM"
		},
		{
			description: "Deposit Topup - KHAIRUL HAFFIZ BIN KHAIRUL OMAR KUMAR",
			amount: "51.28",
			method: "Mandate",
			status: "Success",
			date: "07/08/2024 13:37 PM"
					...
					<div className="space-y-4">
						...
						<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
							...
							<div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
								...
								<div className="text-3xl font-bold text-gray-800 mt-2">1,447</div>
				</div>
						</div>
					</div>
				);
							...
							<div className="rounded-lg border border-gray-200">
								...
								<div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4">
									<div>
										...
										<div className="font-semibold text-gray-800">NOR ZAKIAH BINTI WAN OMAR</div>
									</div>
								<div>
										<div className="text-gray-500 text-sm mb-1">Phone Number</div>
										<div className="font-semibold text-gray-800">+60192131100</div>
									</div>
								</div>
							</div>
							...
							<div className="rounded-lg border border-gray-200">
								...
								<div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4">
									<div className="md:col-span-2">
										...
										<div className="font-semibold text-gray-800">NO 27A JALAN SG 1/6 TAMAN SRI GOMBAK</div>
									</div>
									<div>
										<div className="text-gray-500 text-sm mb-1">Postal Code</div>
										<div className="font-semibold text-gray-800">68100</div>
								</div>
								<div>
										<div className="text-gray-500 text-sm mb-1">City</div>
										<div className="font-semibold text-gray-800">BATU CAVES</div>
								</div>
								<div>
										<div className="text-gray-500 text-sm mb-1">State</div>
										<div className="font-semibold text-gray-800">Selangor</div>
									</div>
								</div>
							</div>
								...
								<div className="flex items-start gap-4">
									...
									<div className="flex-1">
										...
										<p className="text-gray-600 text-sm mb-3">
											This streamlines the collection of your membership fee. The payment amount are determined by your chosen frequency option: Monthly (RM40), Quarterly (RM100), Half-Yearly (RM200), or Annually (RM360). This ensures timely payment effortlessly, tailored to your preferred frequency.
										</p>
							...
							<div className="border border-gray-200 rounded-lg p-4">
								<div className="flex items-start gap-4">
									...
									<div className="flex-1">
										...
										<p className="text-gray-600 text-sm mb-3">
											This serves the purpose of collecting your sharing account payment. Whenever your sharing account falls below a threshold, this emandate is used to collect the required sharing account to guarantee that your membership remains active.
										</p>
										<div className="flex gap-3">
											<button className="px-4 py-2 bg-emerald-600 text-white rounded-lg text-sm hover:bg-emerald-700 transition-colors">
												View Payment Details
								...
								<div className="bg-white border border-gray-200 rounded-lg p-6">
									...
									<div className="space-y-3">
										<div className="flex gap-2">
											<input
												type="text"
												value="https://app.wekongsi.com/auth/register/usr."
												readOnly
								...
								<div className="bg-white border border-gray-200 rounded-lg p-6">
									...
									<div className="space-y-3">
										<div className="flex gap-2">
											<input
												type="text"
												value="https://www.wekongsi.com/agent/usr_2024"
												readOnly
												className="flex-1 px-3 py-2 border border-gray-300 rounded-lg bg-gray-50 text-sm"
											/>
											<button className="px-4 py-2 bg-emerald-600 text-white rounded-lg text-sm hover:bg-emerald-700 transition-colors">
								...
								<div className="bg-white border border-gray-200 rounded-lg p-6">
									<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
										<div>
											...
											<div className="font-semibold text-gray-800">Bank Simpanan Nasional</div>
										</div>
										<div>
											<div className="text-gray-500 text-sm mb-1">Owner Name</div>
											<div className="font-semibold text-gray-800">KHAIRUL HAFFIZ BIN KHAIRUL OMAR</div>
										</div>
										<div>
											<div className="text-gray-500 text-sm mb-1">Bank Account Number</div>
											<div className="font-semibold text-gray-800">1412941000110227</div>
								</div>
								<div>
											<div className="text-gray-500 text-sm mb-1">Owner NRIC</div>
											<div className="font-semibold text-gray-800">851201145835</div>
										</div>
									</div>
									<div className="mt-6">
							...
							<StaggeredContainer className="space-y-4">
								<StaggeredItem>
									<div className="space-y-3">
										...
										<div>
											<div className="font-bold text-lg text-gray-800">NOR ZAKIAH BINTI WAN OMAR</div>
